...
Usage
To use these scripts, ensure you have Python 3.x installed. Download or clone this repository and run the desired script from the command line as shown in the examples above.

Each script provides an inline Usage message if run with incorrect arguments or without any arguments.
